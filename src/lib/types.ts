...
export const EQUIPOS_POR_UNION = {
	...
	URMDP: [
		{ label: 'Biguá R.C.', slug: 'URMDP/BIGUA-RC.PNG' },
		{ label: 'Camarones', slug: 'URMDP/CAMARONES.PNG' },
		{ label: 'Club Social y Campo de Pato', slug: 'URMDP/CLUB-SOCIAL-Y-CAMPO-DE-PATO.PNG' },
		{ label: 'Comercial R.C.', slug: 'URMDP/COMERCIAL-RC.PNG' },
		{ label: 'C.U.D.S.', slug: 'URMDP/CUDS.PNG' },
		{ label: 'Gnomos R.C.', slug: 'URMDP/GNOMOS-RC.PNG' },
		{ label: 'Los 50', slug: 'URMDP/LOS-50.PNG' },
		{ label: 'Los Cardos R.C.', slug: 'URMDP/LOS-CARDOS-RC.PNG' },
		{ label: 'Mar del Plata', slug: 'URMDP/MAR-DEL-PLATA.PNG' },
		{ label: 'Miramar R.C.', slug: 'URMDP/MIRAMAR-RC.PNG' },
		{ label: 'Náutico Necochea', slug: 'URMDP/NAUTICO-NECOCHEA.PNG' },
		{ label: 'Necochea', slug: 'URMDP/NECOCHEA.PNG' },
		{ label: 'Pampas R.C.', slug: 'URMDP/PAMPAS-RC.PNG' },
		{ label: 'Pueyrredón R.C.', slug: 'URMDP/PUEYRREDON-RC.PNG' },
		{ label: 'San Ignacio', slug: 'URMDP/SAN-IGNACIO.PNG' },
		{ label: 'Sporting', slug: 'URMDP/SPORTING.PNG' },
		{ label: 'T.F. Ayacucho', slug: 'URMDP/TF-AYACUCHO.PNG' },
