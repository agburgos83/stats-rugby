<script lang="ts">
  ...
  function obtenerPosicionTeorica(numero: number): string {
      const posiciones: Record<number, string> = {
        ...
        11: "Wing izquierdo", 12: "Primer centro", 13: "Segundo centro", 14: "Wing derecho",
        15: "Fullback"
      };
  ...
  const jugadoresCargados = filas.slice(1)
  ...
  let equipo = $state(Array(23).fill(null).map((_, i) => ({
		numero: i + 1,
